...
menuvar=("SM-A30S" "SM-M30S" "SM-A205" "SM-M305" "SM-A305" "SM-M205" "SM-A405" "SM-A105" "build_all" "Exit")
...
do
    case $menuvar in
	    ...
	    BUILD_ZIMAGE
           # PACK_BOOT_IMG
	   # cp $MK_KERNEL /home/m/share/KERNEL/MinhKer_kernel_Q_a10_v14.6_pro/Image
	...
	"SM-A30S")
	    ...
	    BUILD_ZIMAGE
           # PACK_BOOT_IMG
	    cp $MK_KERNEL /home/m/share/KERNEL/MinhKer_kernel_Q_A30S_v14.6_pro/Image
             echo "$MK_VARIANT kernel build and coppy finished."
	    break
            ;;
 "SM-A205")
	    ...
	    BUILD_ZIMAGE
           # PACK_BOOT_IMG
	    cp $MK_KERNEL /home/m/share/KERNEL/MinhKer_kernel_Q_a20_v14.6_little/Image
             echo "$MK_VARIANT kernel build and coppy finished."
	    break
            ;;
	"SM-M205")
	...
	"SM-A405")
	    ...
	    BUILD_ZIMAGE
           # PACK_BOOT_IMG
	    cp $MK_KERNEL /home/m/share/KERNEL/MinhKer_kernel_Q_a40_v14.6_little/Image
             echo "$MK_VARIANT kernel build and coppy finished."
	    break
            ;;
"SM-A105")
